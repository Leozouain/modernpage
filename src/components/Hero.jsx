...
const Hero = () => (
  ...
  bg-discount-gradient rounded-[10px] mb-2"
      ...
      <div className="flex flex-row justify-between items-center w-full">
        ...
        <a
          href="#cta"
          className="ss:flex hidden md:mr-4 mr-0 cursor-pointer z-[2] scroll-smooth"
        >
          <GetStarted />
        </a>
      </div>
    ...
    <div
      className={`flex-1 flex ${styles.flexCenter} md:my-0 my-10 overflow-hidden`}
    >
      <img
        src={robot}
        alt="billing"
        className="w-[100%] h-[100%] relative z-[5] overflow-hidden"
      />
      <div className="absolute z-[0] w-[40%] h-[35%] top-0 pink__gradient" />
      <div className="absolute z-[1] w-[40%] h-[80%]  white__gradient rounded-full bottom-40" />
